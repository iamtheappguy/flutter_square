...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    // Build the contact from the user
    final contact = square.Contact(
      (b) => b
        ..givenName = 'Test'
        ..familyName = 'Account'
        ..countryCode = 'GB'
    ...
    try {
      String squareApplicationId = 'TODO';
      String squareLocationId = 'TODO';
  ...
  void _onBuyerVerificationSuccess(BuyerVerificationDetails result) {}

  void _onBuyerVerificationFailure(ErrorInfo errorInfo) {}
